...
| Supabase | competitor_videos | `dtxosfdjdozapwbpubom` |
| Airtable Base | Noe Content System | `appXXXXXXXXXXXXX` |
...
```bash
python3 scripts/pull_yt_competitors.py --channel "Nate Herk"
```
...
```bash
python3 scripts/pull_yt_competitors.py --channel "Nick Saraev" --backfill
```
